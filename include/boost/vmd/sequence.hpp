...
/** \brief Expands to a tuple of the v-sequence type/element and the preprocessor tokens after the v-sequence element.
    ...
    or BOOST_VMD_RETURN_EXACT_TYPE, with the latter value the default value. 
    ...
    of an array or a list. With BOOST_VMD_RETURN_EXACT_TYPE, in order to determine the element 
...
*/
#define BOOST_VMD_ONLY_ELEM(elem,...) \
...
*/
#define BOOST_VMD_ONLY_ELEM_D(d,elem,...) \
...
*/
#define BOOST_VMD_DATA_ONLY_ELEM(elem,vseq) \
...
*/
#define BOOST_VMD_DATA_ONLY_ELEM_D(d,elem,vseq) \
...
/** \brief Expands to an array whose elements are the v-types of a v-sequence.
    ...
    are tested among other types for a possible tuple. With BOOST_VMD_RETURN_EXACT_TYPE, 
...
/** \brief Reentrant - expands to a list whose elements are the v-type values of a v-sequence.
