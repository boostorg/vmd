...
#define BOOST_VMD_DETAIL_IS_ARRAY_CHECK_TUPLE_SIZE_IRESULT(array) \
  	BOOST_PP_IIF \
		( \
...
#define BOOST_VMD_DETAIL_IS_ARRAY_CHECK_TUPLE_SIZE(array) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_IS_ARRAY_CHECK_TUPLE_SIZE_IRESULT(array)) \
/**/
...
#define BOOST_VMD_DETAIL_IS_ARRAY_CHECK_NUMERIC_MATCH_PROCESS_IRESULT(x) \
    BOOST_PP_IIF \
      ( \
...
#define BOOST_VMD_DETAIL_IS_ARRAY_CHECK_NUMERIC_MATCH_PROCESS(x) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_IS_ARRAY_CHECK_NUMERIC_MATCH_PROCESS_IRESULT(x)) \
/**/

#define BOOST_VMD_DETAIL_IS_ARRAY_CHECK_EMPTY_TUPLE(x) \
	BOOST_PP_BITAND \
		( \
		BOOST_PP_EQUAL \
			( \
			BOOST_PP_TUPLE_SIZE(x), \
			1 \
			), \
		BOOST_VMD_IS_EMPTY \
			( \
...
#define BOOST_VMD_DETAIL_IS_ARRAY_CHECK_EMPTY_IRESULT(x) \
    BOOST_PP_IIF \
      ( \
      BOOST_VMD_IS_TUPLE(x), \
      BOOST_VMD_DETAIL_IS_ARRAY_CHECK_EMPTY_TUPLE, \
      BOOST_VMD_IDENTITY(0) \
      ) \
    (x) \
/**/
...
#define BOOST_VMD_DETAIL_IS_ARRAY_CHECK_EMPTY(x) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_IS_ARRAY_CHECK_EMPTY_IRESULT(BOOST_PP_TUPLE_ELEM(1,x))) \
/**/
...
#define BOOST_VMD_DETAIL_IS_ARRAY_CHECK_ARRAY_FORM_IRESULT(x) \
    BOOST_PP_IIF \
      ( \
...
#define BOOST_VMD_DETAIL_IS_ARRAY_CHECK_ARRAY_FORM(x) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_IS_ARRAY_CHECK_ARRAY_FORM_IRESULT(x)) \
/**/
