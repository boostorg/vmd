...
#define BOOST_VMD_DETAIL_SEQUENCE_STATE_RESULT_ADD_GET_DATA_IR(state,tuple) \
	BOOST_PP_IIF \
		( \
...
#define BOOST_VMD_DETAIL_SEQUENCE_STATE_RESULT_ADD_GET_DATA(state,tuple) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_SEQUENCE_STATE_RESULT_ADD_GET_DATA_IR(state,tuple)) \
/**/
...
#define	BOOST_VMD_DETAIL_SEQUENCE_TYPE_FOUND_SEQ_IR(state,tuple) \
	BOOST_PP_IIF \
		( \
		BOOST_PP_EQUAL \
			( \
...
#define	BOOST_VMD_DETAIL_SEQUENCE_TYPE_FOUND_SEQ(state,tuple) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_SEQUENCE_TYPE_FOUND_SEQ_IR(state,tuple)) \
/**/
