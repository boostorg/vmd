...
#define BOOST_VMD_DETAIL_SEQUENCE_STATE_RESULT_ADD_GET_DATA_IR(d,state,tuple) \
	BOOST_PP_IIF \
		( \
...
#define BOOST_VMD_DETAIL_SEQUENCE_STATE_RESULT_ADD_GET_DATA(d,state,tuple) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_SEQUENCE_STATE_RESULT_ADD_GET_DATA_IR(d,state,tuple)) \
/**/
...
#define BOOST_VMD_DETAIL_SEQUENCE_PROCESSING_ELEM_IR(d,state) \
	BOOST_PP_IIF \
		( \
...
#define BOOST_VMD_DETAIL_SEQUENCE_PROCESSING_ELEM(d,state) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_SEQUENCE_PROCESSING_ELEM_IR(d,state)) \
/**/
...
#define	BOOST_VMD_DETAIL_SEQUENCE_TYPE_FOUND_SEQ_IR(d,state,tuple) \
	BOOST_PP_IIF \
		( \
		BOOST_PP_EQUAL_D \
			( \
...
#define	BOOST_VMD_DETAIL_SEQUENCE_TYPE_FOUND_SEQ(d,state,tuple) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_SEQUENCE_TYPE_FOUND_SEQ_IR(d,state,tuple)) \
/**/
...
#define BOOST_VMD_DETAIL_SEQUENCE_OP_PAREN_TUPLE_TYPES_ANY_NOE_IR(d,state) \
	BOOST_PP_IIF \
		( \
		BOOST_VMD_DETAIL_SEQUENCE_STATE_IS_NO_RETURN \
			( \
...
#define BOOST_VMD_DETAIL_SEQUENCE_OP_PAREN_TUPLE_TYPES_ANY_NOE(d,state) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_SEQUENCE_OP_PAREN_TUPLE_TYPES_ANY_NOE_IR(d,state)) \
/**/

#define BOOST_VMD_DETAIL_SEQUENCE_OP_PAREN_TUPLE_TYPES_ANY_IR(d,state) \
	BOOST_PP_IIF \
		( \
		BOOST_VMD_IS_EMPTY \
			( \
...
#define BOOST_VMD_DETAIL_SEQUENCE_OP_PAREN_TUPLE_TYPES_ANY(d,state) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_SEQUENCE_OP_PAREN_TUPLE_TYPES_ANY_IR(d,state)) \
/**/
...
#define BOOST_VMD_DETAIL_SEQUENCE_PRED_CELEM_IR(d,state) \
	BOOST_PP_IIF \
		( \
		BOOST_PP_BITOR \
			( \
...
#define BOOST_VMD_DETAIL_SEQUENCE_PRED_CELEM(d,state) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_SEQUENCE_PRED_CELEM_IR(d,state)) \
/**/

#define BOOST_VMD_DETAIL_SEQUENCE_PRED_IR(d,state) \
	BOOST_PP_IIF \
		( \
		BOOST_VMD_IS_EMPTY \
			( \
...
#define BOOST_VMD_DETAIL_SEQUENCE_PRED(d,state) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_SEQUENCE_PRED_IR(d,state)) \
/**/
