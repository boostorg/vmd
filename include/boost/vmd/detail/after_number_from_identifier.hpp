...
#define BOOST_VMD_DETAIL_AFTER_NUMBER_FROM_IDENTIFIER_CHECK_LIMITS_IRESULT(...) \
	BOOST_PP_IIF \
		( \
		BOOST_PP_BITOR \
			( \
...
#define BOOST_VMD_DETAIL_AFTER_NUMBER_FROM_IDENTIFIER_CHECK_LIMITS(...) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_AFTER_NUMBER_FROM_IDENTIFIER_CHECK_LIMITS_IRESULT(__VA_ARGS__)) \
/**/

#define BOOST_VMD_DETAIL_AFTER_NUMBER_FROM_IDENTIFIER_CHECK_NUMBER_IRESULT(...) \
	BOOST_PP_IIF \
		( \
...
#define BOOST_VMD_DETAIL_AFTER_NUMBER_FROM_IDENTIFIER_CHECK_NUMBER(...) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_AFTER_NUMBER_FROM_IDENTIFIER_CHECK_NUMBER_IRESULT(__VA_ARGS__)) \
/**/
...
#define BOOST_VMD_DETAIL_AFTER_NUMBER_FROM_IDENTIFIER_CHECK_MORE_NUMBERS_IRESULT(...) \
	BOOST_PP_IIF \
		( \
...
#define BOOST_VMD_DETAIL_AFTER_NUMBER_FROM_IDENTIFIER_CHECK_MORE_NUMBERS(...) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_AFTER_NUMBER_FROM_IDENTIFIER_CHECK_MORE_NUMBERS_IRESULT(__VA_ARGS__)) \
/**/

#define BOOST_VMD_DETAIL_AFTER_NUMBER_FROM_IDENTIFIER_NEXT_PEN_IRESULT(...) \
	BOOST_PP_IIF \
		( \
...
#define BOOST_VMD_DETAIL_AFTER_NUMBER_FROM_IDENTIFIER_NEXT_PEN(...) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_AFTER_NUMBER_FROM_IDENTIFIER_NEXT_PEN_IRESULT(__VA_ARGS__)) \
/**/
