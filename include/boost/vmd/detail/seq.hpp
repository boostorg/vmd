...
#define BOOST_VMD_DETAIL_SEQ_STATE_INIT(seq) \
	BOOST_PP_TUPLE_PUSH_BACK \
		( \
		BOOST_VMD_TUPLE(seq), \
		BOOST_VMD_SEQ_CONTINUE \
		) \
/**/

#define BOOST_VMD_DETAIL_SEQ_STATE_CONTINUE(state) \
    BOOST_VMD_IS_EMPTY \
		( \
		BOOST_PP_CAT \
      		( \
      		BOOST_VMD_DETAIL_SEQ_CHELPER_, \
...
#define BOOST_VMD_DETAIL_SEQ_STATE_SUCCESS(state) \
	BOOST_VMD_IS_EMPTY \
      	( \
      	BOOST_PP_CAT \
      		( \
      		BOOST_VMD_DETAIL_SEQ_SHELPER_, \
      		BOOST_PP_TUPLE_ELEM(2,state) \
      		) \
      	BOOST_PP_EMPTY() \
      	) \
...
#define BOOST_VMD_DETAIL_SEQ_STATE_FAILURE(state) \
    BOOST_VMD_IS_EMPTY \
      	( \
      	BOOST_PP_CAT \
      		( \
      		BOOST_VMD_DETAIL_SEQ_FHELPER_, \
      		BOOST_PP_TUPLE_ELEM(2,state) \
      		) \
      	BOOST_PP_EMPTY() \
      	) \
...
#define BOOST_VMD_DETAIL_SEQ_STATE_PRED(d,state) \
	BOOST_VMD_DETAIL_SEQ_STATE_CONTINUE(state) \
/**/
...
#define BOOST_VMD_DETAIL_SEQ_STATE_OP_CHECK_SIZE(d,state) \
	BOOST_PP_IIF \
		( \
		BOOST_PP_EQUAL \
			( \
...
#define BOOST_VMD_DETAIL_SEQ_STATE_OP(d,state) \
	BOOST_PP_IIF \
		...
		BOOST_VMD_DETAIL_SEQ_STATE_OP_SET_FAILURE, \
		BOOST_VMD_DETAIL_SEQ_STATE_OP_CHECK_SIZE \
		) \
	(d,state) \
/**/
...
#define BOOST_VMD_DETAIL_SEQ_STATE_RESULT(state) \
  	BOOST_PP_NOT \
		( \
		BOOST_VMD_DETAIL_SEQ_STATE_FAILURE(state) \
		) \
/**/

#define BOOST_VMD_DETAIL_SEQ_SHELPER_BOOST_VMD_SEQ_SUCCESS
#define BOOST_VMD_DETAIL_SEQ_FHELPER_BOOST_VMD_SEQ_FAILURE
#define BOOST_VMD_DETAIL_SEQ_CHELPER_BOOST_VMD_SEQ_CONTINUE
