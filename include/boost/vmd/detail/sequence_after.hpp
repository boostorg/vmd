...
#define BOOST_VMD_DETAIL_SEQUENCE_AFTER(elem,vseq) \
	BOOST_VMD_DETAIL_SEQUENCE_ELEM(BOOST_VMD_ALLOW_AFTER,elem,vseq,BOOST_VMD_RETURN_ONLY_AFTER) \
/**/

#define BOOST_VMD_DETAIL_SEQUENCE_AFTER_D(d,elem,vseq) \
	BOOST_VMD_DETAIL_SEQUENCE_ELEM_D(d,BOOST_VMD_ALLOW_AFTER,elem,vseq,BOOST_VMD_RETURN_ONLY_AFTER) \
/**/
