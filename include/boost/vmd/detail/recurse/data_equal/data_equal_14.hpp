...
#define BOOST_VMD_DETAIL_DATA_EQUAL_14_LOOP(dataf,datas,sz,eaccess) \
	BOOST_PP_TUPLE_ELEM \
		( \
		0, \
		BOOST_PP_WHILE \
...
#define BOOST_VMD_DETAIL_DATA_EQUAL_14_LOOP_D(d,dataf,datas,sz,eaccess) \
	BOOST_PP_TUPLE_ELEM \
		( \
		0, \
		BOOST_PP_WHILE_ ## d \
...
#define BOOST_VMD_DETAIL_DATA_EQUAL_14_SZ_IR(dataf,datas,szf,szs,eaccess) \
	BOOST_PP_IIF \
		( \
...
#define BOOST_VMD_DETAIL_DATA_EQUAL_14_SZ_IR_D(d,dataf,datas,szf,szs,eaccess) \
	BOOST_PP_IIF \
		( \
...
#define BOOST_VMD_DETAIL_DATA_EQUAL_14_SZ(dataf,datas,szf,szs,eaccess) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_DATA_EQUAL_14_SZ_IR(dataf,datas,szf,szs,eaccess)) \
/**/

#define BOOST_VMD_DETAIL_DATA_EQUAL_14_SZ_D(d,dataf,datas,szf,szs,eaccess) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_DATA_EQUAL_14_SZ_IR_D(d,dataf,datas,szf,szs,eaccess)) \
/**/

#define BOOST_VMD_DETAIL_DATA_EQUAL_14_PAR_3(dataf,datas,esize,eaccess) \
	BOOST_VMD_DETAIL_DATA_EQUAL_14_SZ(dataf,datas,esize(dataf),esize(datas),eaccess) \
/**/

#define BOOST_VMD_DETAIL_DATA_EQUAL_14_PAR_D_3(d,dataf,datas,esize,eaccess) \
	BOOST_VMD_DETAIL_DATA_EQUAL_14_SZ_D(d,dataf,datas,esize(dataf),esize(datas),eaccess) \
/**/

#define BOOST_VMD_DETAIL_DATA_EQUAL_14_PAR_1(dataf,datas) \
	BOOST_VMD_DETAIL_DATA_EQUAL_14_SZ(dataf,datas,BOOST_PP_LIST_SIZE(dataf),BOOST_PP_LIST_SIZE(datas),BOOST_PP_LIST_AT_D) \
/**/

#define BOOST_VMD_DETAIL_DATA_EQUAL_14_PAR_D_1(d,dataf,datas) \
	BOOST_VMD_DETAIL_DATA_EQUAL_14_SZ_D(d,dataf,datas,BOOST_PP_LIST_SIZE_D(d,dataf),BOOST_PP_LIST_SIZE_D(d,datas),BOOST_PP_LIST_AT_D) \
/**/
