...
#define BOOST_VMD_DETAIL_DATA_EQUAL_5_OP_TEQ_CMP_PARENS_IR(d,em1,em2) \
	BOOST_PP_IIF \
		( \
...
#define BOOST_VMD_DETAIL_DATA_EQUAL_5_OP_TEQ_CMP_PARENS_IR_D(d,em1,em2) \
	BOOST_PP_IIF \
		( \
		BOOST_VMD_DETAIL_DATA_EQUAL_IS_BOTH_COMPOSITE(em1,em2), \
		BOOST_VMD_IDENTITY(2), \
...
#define BOOST_VMD_DETAIL_DATA_EQUAL_5_OP_TEQ_CMP_PARENS(d,em1,em2) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_DATA_EQUAL_5_OP_TEQ_CMP_PARENS_IR(d,em1,em2)) \
/**/

#define BOOST_VMD_DETAIL_DATA_EQUAL_5_OP_TEQ_CMP_PARENS_D(d,em1,em2) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_DATA_EQUAL_5_OP_TEQ_CMP_PARENS_IR_D(d,em1,em2)) \
/**/
...
#define BOOST_VMD_DETAIL_DATA_EQUAL_5(dataf,...) \
	BOOST_PP_CAT(BOOST_PP_OVERLOAD(BOOST_VMD_DETAIL_DATA_EQUAL_5_PAR_,__VA_ARGS__)(dataf,__VA_ARGS__),BOOST_PP_EMPTY()) \
/**/

#define BOOST_VMD_DETAIL_DATA_EQUAL_5_D(d,dataf,...) \
	BOOST_PP_CAT(BOOST_PP_OVERLOAD(BOOST_VMD_DETAIL_DATA_EQUAL_5_PAR_D_,__VA_ARGS__)(d,dataf,__VA_ARGS__),BOOST_PP_EMPTY()) \
/**/

#else

#define BOOST_VMD_DETAIL_DATA_EQUAL_5(dataf,...) \
	BOOST_PP_OVERLOAD(BOOST_VMD_DETAIL_DATA_EQUAL_5_PAR_,__VA_ARGS__)(dataf,__VA_ARGS__) \
/**/

#define BOOST_VMD_DETAIL_DATA_EQUAL_5_D(d,dataf,...) \
	BOOST_PP_OVERLOAD(BOOST_VMD_DETAIL_DATA_EQUAL_5_PAR_D_,__VA_ARGS__)(d,dataf,__VA_ARGS__) \
/**/
