...
#define BOOST_VMD_DETAIL_DATA_EQUAL_OP_TEQ_CMP_PARENS_IR(d,em1,em2) \
	BOOST_PP_IIF \
		( \
...
#define BOOST_VMD_DETAIL_DATA_EQUAL_OP_TEQ_CMP_PARENS_IR_D(d,em1,em2) \
	BOOST_PP_IIF \
		( \
		BOOST_VMD_DETAIL_DATA_EQUAL_IS_BOTH_COMPOSITE(em1,em2), \
		BOOST_VMD_IDENTITY(2), \
...
#define BOOST_VMD_DETAIL_DATA_EQUAL_OP_TEQ_CMP_PARENS(d,em1,em2) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_DATA_EQUAL_OP_TEQ_CMP_PARENS_IR(d,em1,em2)) \
/**/

#define BOOST_VMD_DETAIL_DATA_EQUAL_OP_TEQ_CMP_PARENS_D(d,em1,em2) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_DATA_EQUAL_OP_TEQ_CMP_PARENS_IR_D(d,em1,em2)) \
/**/
...
#define BOOST_VMD_DETAIL_DATA_EQUAL_SZ_IR(dataf,datas,szf,szs,vtype) \
	BOOST_PP_IIF \
		( \
...
#define BOOST_VMD_DETAIL_DATA_EQUAL_SZ_IR_D(d,dataf,datas,szf,szs,vtype) \
	BOOST_PP_IIF \
		( \
...
#define BOOST_VMD_DETAIL_DATA_EQUAL_SZ(dataf,datas,szf,szs,vtype) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_DATA_EQUAL_SZ_IR(dataf,datas,szf,szs,vtype)) \
/**/

#define BOOST_VMD_DETAIL_DATA_EQUAL_SZ_D(d,dataf,datas,szf,szs,vtype) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_DATA_EQUAL_SZ_IR_D(d,dataf,datas,szf,szs,vtype)) \
/**/

#define BOOST_VMD_DETAIL_DATA_EQUAL_PAR_2(dataf,datas,vtype) \
...
#define BOOST_VMD_DETAIL_DATA_EQUAL_PAR_D_2(d,dataf,datas,vtype) \
...
#define BOOST_VMD_DETAIL_DATA_EQUAL_PAR_1(dataf,datas) \
	BOOST_VMD_DETAIL_DATA_EQUAL_SZ(dataf,datas,BOOST_PP_LIST_SIZE(dataf),BOOST_PP_LIST_SIZE(datas),BOOST_VMD_TYPE_LIST) \
/**/

#define BOOST_VMD_DETAIL_DATA_EQUAL_PAR_D_1(d,dataf,datas) \
	BOOST_VMD_DETAIL_DATA_EQUAL_SZ_D(d,dataf,datas,BOOST_PP_LIST_SIZE_D(d,dataf),BOOST_PP_LIST_SIZE_D(d,datas),BOOST_VMD_TYPE_LIST) \
/**/
