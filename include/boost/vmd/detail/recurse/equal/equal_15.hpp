...
#define BOOST_VMD_DETAIL_EQUAL_15_CNI_CLIST(vseq1,vseq2,vtype) \
	BOOST_PP_IIF \
		...
		BOOST_VMD_DETAIL_COMP_EQUAL_15_NC \
		) \
	(vseq1,vseq2,vtype) \
/**/
...
#define BOOST_VMD_DETAIL_EQUAL_15_CNI_CLIST_D(d,vseq1,vseq2,vtype) \
	BOOST_PP_IIF \
		...
		BOOST_VMD_DETAIL_COMP_EQUAL_15_NC_D \
		) \
	(d,vseq1,vseq2,vtype) \
/**/
...
#define BOOST_VMD_DETAIL_EQUAL_15_GTYPE(vseq1,vseq2) \
	BOOST_VMD_DETAIL_EQUAL_15_WT \
		...
		vseq1, \
		vseq2, \
		BOOST_VMD_TYPE(vseq1,BOOST_VMD_RETURN_GENERAL_TUPLE_TYPE), \
		BOOST_VMD_TYPE(vseq2,BOOST_VMD_RETURN_GENERAL_TUPLE_TYPE) \
		) \
/**/
