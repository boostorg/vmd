...
#define BOOST_VMD_DETAIL_EQUAL_2_CNI_CLIST_FND(vseq1,vseq2,vtype) \
	BOOST_VMD_DETAIL_LIST_EQUAL_2_NC(vseq1,vseq2) \
/**/

#define BOOST_VMD_DETAIL_EQUAL_2_CNI_CLIST_FND_D(d,vseq1,vseq2,vtype) \
	BOOST_VMD_DETAIL_LIST_EQUAL_2_NC_D(d,vseq1,vseq2) \
/**/

#define BOOST_VMD_DETAIL_EQUAL_2_CNI_CLIST(vseq1,vseq2,vtype) \
	BOOST_PP_IIF \
		( \
		BOOST_VMD_DETAIL_EQUAL_TYPE(vtype,BOOST_VMD_TYPE_LIST), \
		BOOST_VMD_DETAIL_EQUAL_2_CNI_CLIST_FND, \
		BOOST_VMD_DETAIL_DATA_EQUAL_2 \
		) \
	(vseq1,vseq2,vtype) \
/**/

#define BOOST_VMD_DETAIL_EQUAL_2_CNI_CLIST_D(d,vseq1,vseq2,vtype) \
	BOOST_PP_IIF \
		( \
		BOOST_VMD_DETAIL_EQUAL_TYPE_D(d,vtype,BOOST_VMD_TYPE_LIST), \
		BOOST_VMD_DETAIL_EQUAL_2_CNI_CLIST_FND_D, \
...
#define BOOST_VMD_DETAIL_EQUAL_2_CNI(vseq1,vseq2,vtype) \
	BOOST_PP_IIF \
		...
		BOOST_VMD_DETAIL_EQUAL_2_CNI_CLIST, \
...
#define BOOST_VMD_DETAIL_EQUAL_2_CNI_D(d,vseq1,vseq2,vtype) \
	BOOST_PP_IIF \
		...
		BOOST_VMD_DETAIL_EQUAL_2_CNI_CLIST_D, \
		BOOST_VMD_DETAIL_EQUAL_CNI_SMP_D \
		) \
	(d,vseq1,vseq2,vtype) \
/**/

#define BOOST_VMD_DETAIL_EQUAL_2_WT_IR(vseq1,vseq2,vtype1,vtype2) \
	BOOST_PP_IIF \
		( \
...
#define BOOST_VMD_DETAIL_EQUAL_2_WT_IR_D(d,vseq1,vseq2,vtype1,vtype2) \
	BOOST_PP_IIF \
		( \
...
#define BOOST_VMD_DETAIL_EQUAL_2_WT(vseq1,vseq2,vtype1,vtype2) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_EQUAL_2_WT_IR(vseq1,vseq2,vtype1,vtype2)) \
/**/

#define BOOST_VMD_DETAIL_EQUAL_2_WT_D(d,vseq1,vseq2,vtype1,vtype2) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_EQUAL_2_WT_IR_D(d,vseq1,vseq2,vtype1,vtype2)) \
/**/
...
#define BOOST_VMD_DETAIL_EQUAL_2_EBP_IR(vseq1,vseq2,be1,be2) \
	BOOST_PP_IIF \
		( \
		BOOST_PP_BITAND \
			( \
...
#define BOOST_VMD_DETAIL_EQUAL_2_EBP_IR_D(d,vseq1,vseq2,be1,be2) \
	BOOST_PP_IIF \
		( \
		BOOST_PP_BITAND \
			( \
...
#define BOOST_VMD_DETAIL_EQUAL_2_EBP(vseq1,vseq2,be1,be2) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_EQUAL_2_EBP_IR(vseq1,vseq2,be1,be2)) \
/**/

#define BOOST_VMD_DETAIL_EQUAL_2_EBP_D(d,vseq1,vseq2,be1,be2) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_EQUAL_2_EBP_IR_D(d,vseq1,vseq2,be1,be2)) \
/**/
