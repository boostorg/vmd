...
#define BOOST_VMD_DETAIL_EQUAL_11_CNI_CLIST_FND(vseq1,vseq2,vtype) \
	BOOST_VMD_DETAIL_LIST_EQUAL_11_NC(vseq1,vseq2) \
/**/

#define BOOST_VMD_DETAIL_EQUAL_11_CNI_CLIST_FND_D(d,vseq1,vseq2,vtype) \
	BOOST_VMD_DETAIL_LIST_EQUAL_11_NC_D(d,vseq1,vseq2) \
/**/

#define BOOST_VMD_DETAIL_EQUAL_11_CNI_CLIST(vseq1,vseq2,vtype) \
	BOOST_PP_IIF \
		( \
		BOOST_VMD_DETAIL_EQUAL_TYPE(vtype,BOOST_VMD_TYPE_LIST), \
		BOOST_VMD_DETAIL_EQUAL_11_CNI_CLIST_FND, \
		BOOST_VMD_DETAIL_COMP_EQUAL_11_NC \
		) \
	(vseq1,vseq2,vtype) \
/**/

#define BOOST_VMD_DETAIL_EQUAL_11_CNI_CLIST_D(d,vseq1,vseq2,vtype) \
	BOOST_PP_IIF \
		( \
		BOOST_VMD_DETAIL_EQUAL_TYPE_D(d,vtype,BOOST_VMD_TYPE_LIST), \
		BOOST_VMD_DETAIL_EQUAL_11_CNI_CLIST_FND_D, \
		BOOST_VMD_DETAIL_COMP_EQUAL_11_NC_D \
		) \
	(d,vseq1,vseq2,vtype) \
/**/
...
#define BOOST_VMD_DETAIL_EQUAL_11_CNI(vseq1,vseq2,vtype) \
	BOOST_PP_IIF \
		...
		BOOST_VMD_DETAIL_EQUAL_11_CNI_CLIST, \
...
#define BOOST_VMD_DETAIL_EQUAL_11_CNI_D(d,vseq1,vseq2,vtype) \
	BOOST_PP_IIF \
		...
		BOOST_VMD_DETAIL_EQUAL_11_CNI_CLIST_D, \
