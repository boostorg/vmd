...
#define BOOST_VMD_DETAIL_SEQUENCE_TYPE_TUPLE_MODS(dtuple,rtype) \
	BOOST_VMD_IDENTITY_RESULT \
		...
		BOOST_PP_IIF \
			( \
			BOOST_VMD_DETAIL_IS_RETURN_TYPE_ARRAY(rtype), \
			BOOST_VMD_DETAIL_SEQUENCE_TYPE_TUPLE_ARRAY, \
			BOOST_PP_IIF \
				( \
				BOOST_VMD_DETAIL_IS_RETURN_TYPE_LIST(rtype), \
				BOOST_VMD_DETAIL_SEQUENCE_TYPE_TUPLE_LIST, \
				BOOST_PP_IIF \
					( \
					BOOST_VMD_DETAIL_IS_RETURN_TYPE_TUPLE(rtype), \
...
#define BOOST_VMD_DETAIL_SEQUENCE_TYPE_TUPLE_SEQUENCE(tuple,...) \
	BOOST_VMD_IDENTITY_RESULT \
		...
		BOOST_PP_IIF \
			...
			BOOST_VMD_IDENTITY(BOOST_VMD_TYPE_VSEQUENCE) \
			) \
