...
#define BOOST_VMD_DETAIL_SEQUENCE_ELEM_PROCESS_TUPLE_GET_IFROM(...) \
	BOOST_PP_IIF \
		...
		BOOST_VMD_IDENTITY(BOOST_VMD_RETURN_TYPE), \
...
#define BOOST_VMD_DETAIL_SEQUENCE_TO_ARRAY_IRP(seq) \
	BOOST_PP_IIF \
		( \
		BOOST_VMD_IS_EMPTY(seq), \
		BOOST_VMD_IDENTITY((0,())), \
...
#define BOOST_VMD_DETAIL_SEQUENCE_TO_ARRAY_RP(seq) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_SEQUENCE_TO_ARRAY_IRP(seq)) \
/**/
...
#define BOOST_VMD_DETAIL_SEQUENCE_MODS(defv,...) \
	BOOST_PP_TUPLE_ELEM \
		( \
		3, \
		BOOST_PP_WHILE \
...
#define BOOST_VMD_DETAIL_SEQUENCE_ELEM_NEW_IMODS(defv,...) \
	BOOST_PP_IIF \
		( \
		BOOST_PP_EQUAL(BOOST_PP_VARIADIC_SIZE(__VA_ARGS__),1), \
		BOOST_VMD_IDENTITY(defv), \
	...
	BOOST_PP_EXPR_IIF \
		...
		BOOST_VMD_DETAIL_SEQUENCE_ELEM_FSEQ \
			...
			BOOST_VMD_DETAIL_SEQUENCE_ELEM_PROCESS_TUPLE \
				...
				elem, \
				BOOST_VMD_TYPE_SEQ, \
				BOOST_VMD_DETAIL_SEQUENCE_ELEM_NEW_MODS((BOOST_VMD_DETAIL_SEQUENCE_MODS_RETURN,0),__VA_ARGS__) \
				), \
			elem \
			) \
		) \
...
#define BOOST_VMD_DETAIL_SEQUENCE_DATA_ELEM(elem,vseq) \
	BOOST_VMD_DETAIL_SEQUENCE_ELEM(elem,vseq,BOOST_VMD_RETURN_NO_TYPE) \
/**/

#define BOOST_VMD_DETAIL_SEQUENCE_DATA_ELEM_D(d,elem,vseq) \
	BOOST_VMD_DETAIL_SEQUENCE_ELEM_D(d,elem,vseq,BOOST_VMD_RETURN_NO_TYPE) \
/**/
	...
	BOOST_PP_IIF \
		...
		BOOST_VMD_DETAIL_SEQUENCE_ELEM_SPLIT_FSEQ \
			...
			BOOST_VMD_DETAIL_SEQUENCE_ELEM_PROCESS_TUPLE \
				...
				elem, \
				BOOST_VMD_TYPE_SEQ, \
				BOOST_VMD_DETAIL_SEQUENCE_ELEM_NEW_MODS((BOOST_VMD_DETAIL_SEQUENCE_MODS_RETURN,1),__VA_ARGS__) \
				), \
			elem \
			), \
...
#define BOOST_VMD_DETAIL_SEQUENCE_DATA_ELEM_SPLIT(elem,vseq) \
	BOOST_VMD_DETAIL_SEQUENCE_ELEM_SPLIT(elem,vseq,BOOST_VMD_RETURN_NO_TYPE) \
/**/

#define BOOST_VMD_DETAIL_SEQUENCE_DATA_ELEM_SPLIT_D(d,elem,vseq) \
	BOOST_VMD_DETAIL_SEQUENCE_ELEM_SPLIT_D(d,elem,vseq,BOOST_VMD_RETURN_NO_TYPE) \
/**/
...
#define BOOST_VMD_DETAIL_SEQUENCE_SIZE(vseq) \
	BOOST_PP_ARRAY_SIZE(BOOST_VMD_DETAIL_SEQUENCE_TO_ARRAY(vseq,BOOST_VMD_RETURN_NO_TYPE)) \
/**/

#define BOOST_VMD_DETAIL_SEQUENCE_SIZE_D(d,vseq) \
	BOOST_PP_ARRAY_SIZE(BOOST_VMD_DETAIL_SEQUENCE_TO_ARRAY_D(d,vseq,BOOST_VMD_RETURN_NO_TYPE)) \
/**/
...
#define BOOST_VMD_DETAIL_SEQUENCE_DATA_TO_LIST(vseq) \
	BOOST_VMD_DETAIL_SEQUENCE_TO_LIST(vseq,BOOST_VMD_RETURN_NO_TYPE) \
/**/

#define BOOST_VMD_DETAIL_SEQUENCE_DATA_TO_LIST_D(d,vseq) \
	BOOST_VMD_DETAIL_SEQUENCE_TO_LIST_D(d,vseq,BOOST_VMD_RETURN_NO_TYPE) \
/**/
...
#define BOOST_VMD_DETAIL_SEQUENCE_DATA_TO_SEQ(vseq) \
	BOOST_VMD_DETAIL_SEQUENCE_TO_SEQ(vseq,BOOST_VMD_RETURN_NO_TYPE) \
/**/

#define BOOST_VMD_DETAIL_SEQUENCE_DATA_TO_SEQ_D(d,vseq) \
	BOOST_VMD_DETAIL_SEQUENCE_TO_SEQ_D(d,vseq,BOOST_VMD_RETURN_NO_TYPE) \
/**/
