...
#define BOOST_VMD_DETAIL_SEQUENCE_STATE_TYPES_ELEM 3
#define BOOST_VMD_DETAIL_SEQUENCE_STATE_INDEX_ELEM 4
...
#define BOOST_VMD_DETAIL_SEQUENCE_INNER_OP_UNKNOWN(d,state) \
	( \
	, \
	BOOST_VMD_DETAIL_SEQUENCE_TO_SEQ_STATE_RESULT_ADD(state,(BOOST_VMD_TYPE_UNKNOWN,BOOST_VMD_DETAIL_SEQUENCE_STATE_INPUT(state))), \
