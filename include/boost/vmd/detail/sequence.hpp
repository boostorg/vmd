...
#define BOOST_VMD_DETAIL_SEQUENCE_AFTER(elem,vseq) \
	BOOST_PP_TUPLE_ELEM(1,BOOST_VMD_DETAIL_SEQUENCE_ELEM(elem,vseq,BOOST_VMD_RETURN_AFTER)) \
/**/

#define BOOST_VMD_DETAIL_SEQUENCE_AFTER_D(d,elem,vseq) \
	BOOST_PP_TUPLE_ELEM(1,BOOST_VMD_DETAIL_SEQUENCE_ELEM_D(d,elem,vseq,BOOST_VMD_RETURN_AFTER)) \
/**/
