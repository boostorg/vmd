...
#define BOOST_VMD_DETAIL_SEQUENCE_STATE_IS_NO_RETURN(from) \
	BOOST_VMD_DETAIL_SEQUENCE_STATE_IS_RETURN(from,0) \
/**/

#define BOOST_VMD_DETAIL_SEQUENCE_STATE_IS_EXACT_RETURN(from) \
	BOOST_VMD_DETAIL_SEQUENCE_STATE_IS_RETURN(from,1) \
/**/

#define BOOST_VMD_DETAIL_SEQUENCE_STATE_IS_GENERAL_RETURN(from) \
	BOOST_VMD_DETAIL_SEQUENCE_STATE_IS_RETURN(from,2) \
/**/

#define BOOST_VMD_DETAIL_SEQUENCE_STATE_IS_ARRAY_RETURN(from) \
	BOOST_VMD_DETAIL_SEQUENCE_STATE_IS_RETURN(from,3) \
/**/

#define BOOST_VMD_DETAIL_SEQUENCE_STATE_IS_LIST_RETURN(from) \
	BOOST_VMD_DETAIL_SEQUENCE_STATE_IS_RETURN(from,4) \
/**/
...
#define BOOST_VMD_DETAIL_SEQUENCE_ELEM_PROCESS(vseq,elem,output,from) \
	BOOST_PP_TUPLE_ELEM \
		( \
		0, \
		BOOST_VMD_DETAIL_SEQUENCE_ELEM_PROCESS_TUPLE(vseq,elem,output,from) \
		) \
/**/

#define BOOST_VMD_DETAIL_SEQUENCE_ELEM_PROCESS_D(d,vseq,elem,output,from) \
	BOOST_PP_TUPLE_ELEM \
		( \
		0, \
		BOOST_VMD_DETAIL_SEQUENCE_ELEM_PROCESS_TUPLE_D(d,vseq,elem,output,from) \
		) \
/**/
	...
	BOOST_PP_EXPR_IIF \
		...
		BOOST_VMD_DETAIL_SEQUENCE_ELEM_FSEQ \
			...
			BOOST_VMD_DETAIL_SEQUENCE_ELEM_PROCESS \
				...
				elem, \
				BOOST_VMD_TYPE_SEQ, \
				BOOST_VMD_DETAIL_SEQUENCE_ELEM_NEW_MODS((1,0),__VA_ARGS__) \
				), \
			elem \
			) \
		) \
