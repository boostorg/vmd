...
#define BOOST_VMD_DETAIL_ELEM_IDENTIFIER_CHK_NE_IND_IFALSE(id,mods) \
	BOOST_PP_IIF \
		( \
		BOOST_VMD_IS_EMPTY(id), \
...
#define BOOST_VMD_DETAIL_ELEM_IDENTIFIER_CHK_INDF(id,mods) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_ELEM_IDENTIFIER_CHK_NE_IND_IFALSE(id,mods)) \
/**/
...
#define BOOST_VMD_DETAIL_ELEM_IDENTIFIER_CHK_IPRE(id,mods,cempty) \
	BOOST_PP_IIF \
		( \
		cempty, \
		BOOST_VMD_IDENTITY(id), \
...
#define BOOST_VMD_DETAIL_ELEM_IDENTIFIER_CHK_PRE(id,mods,cempty) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_ELEM_IDENTIFIER_CHK_IPRE(id,mods,cempty)) \
/**/
