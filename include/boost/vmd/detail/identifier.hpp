...
#define BOOST_VMD_DETAIL_IDENTIFIER_SPLIT_SEQUENCE_CONCAT_DATA_IR(tuple) \
	BOOST_PP_IIF \
		( \
		BOOST_VMD_IS_EMPTY \
			( \
...
#define BOOST_VMD_DETAIL_IDENTIFIER_SPLIT_SEQUENCE_CONCAT_DATA(tuple) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_IDENTIFIER_SPLIT_SEQUENCE_CONCAT_DATA_IR(tuple)) \
/**/ \
...
#define BOOST_VMD_DETAIL_IDENTIFIER_GETID_TID_IR(tid) \
	BOOST_PP_IIF \
		( \
...
#define BOOST_VMD_DETAIL_IDENTIFIER_GETID_TID(tid) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_IDENTIFIER_GETID_TID_IR(tid)) \
/**/
...
#define BOOST_VMD_DETAIL_AFTER_IDENTIFIER(...) \
	BOOST_PP_TUPLE_ELEM \
		( \
		1, \
...
#define BOOST_VMD_DETAIL_AFTER_IDENTIFIER_D(d,...) \
	BOOST_PP_TUPLE_ELEM \
		( \
		1, \
...
#define BOOST_VMD_DETAIL_IS_BEGIN_IDENTIFIER(...) \
	BOOST_PP_NOT \
		...
		BOOST_VMD_IS_EMPTY \
			( \
			BOOST_VMD_DETAIL_IDENTIFIER(__VA_ARGS__,BOOST_VMD_RETURN_NO_AFTER,BOOST_VMD_RETURN_NO_INDEX) \
			) \
		) \
/**/
...
#define BOOST_VMD_DETAIL_IS_BEGIN_IDENTIFIER_D(d,...) \
	BOOST_PP_NOT \
		...
		BOOST_VMD_IS_EMPTY \
			( \
			BOOST_VMD_DETAIL_IDENTIFIER(d,__VA_ARGS__,BOOST_VMD_RETURN_NO_AFTER,BOOST_VMD_RETURN_NO_INDEX) \
			) \
		) \
/**/
