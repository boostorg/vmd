...
#define BOOST_VMD_DETAIL_INTERNAL_IDENTIFIER(vseq) \
	BOOST_VMD_DETAIL_IDENTIFIER(vseq,BOOST_VMD_RETURN_AFTER) \
/**/

#define BOOST_VMD_DETAIL_INTERNAL_IDENTIFIER_D(d,vseq) \
	BOOST_VMD_DETAIL_IDENTIFIER_D(d,vseq,BOOST_VMD_RETURN_AFTER) \
/**/
