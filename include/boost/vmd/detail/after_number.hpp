...
#define BOOST_VMD_DETAIL_AFTER_NUMBER_GET(parameter) \
	( \
	BOOST_VMD_DETAIL_AFTER_NUMBER_GET_NUMBER(parameter), \
	BOOST_VMD_DETAIL_AFTER_NUMBER_CONCATENATE(parameter) \
	) \
/**/

#define BOOST_VMD_DETAIL_AFTER_NUMBER_NOT_FOUND(parameter) \
	(,) \
/**/

#define BOOST_VMD_DETAIL_AFTER_NUMBER_CONCATENATE(parameter) \
	BOOST_PP_CAT \
		( \
...
#define BOOST_VMD_DETAIL_AFTER_NUMBER(parameter) \
	BOOST_PP_IIF \
		( \
