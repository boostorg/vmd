...
#define BOOST_VMD_DETAIL_AFTER_NUMBER_CHECK_MORE_NUMBERS_DO_COMP(size) \
 	BOOST_PP_LESS(1,size) \
/**/
...
#define BOOST_VMD_DETAIL_AFTER_NUMBER_CHECK_MORE_NUMBERS(...) \
	BOOST_PP_IIF \
		( \
		BOOST_VMD_DETAIL_AFTER_NUMBER_CHECK_MORE_NUMBERS_DO_COMP(BOOST_PP_VARIADIC_SIZE(__VA_ARGS__)), \
