...
#define BOOST_VMD_DETAIL_AFTER_NUMBER_CHECK_LIMITS_IRESULT(...) \
	BOOST_PP_IIF \
		( \
		BOOST_PP_BITOR \
			( \
...
#define BOOST_VMD_DETAIL_AFTER_NUMBER_CHECK_LIMITS(...) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_AFTER_NUMBER_CHECK_LIMITS_IRESULT(__VA_ARGS__)) \
/**/
...
#define BOOST_VMD_DETAIL_AFTER_NUMBER_CHECK_IDENTIFIER_IRESULT(...) \
	BOOST_PP_IIF \
		( \
...
#define BOOST_VMD_DETAIL_AFTER_NUMBER_CHECK_IDENTIFIER(...) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_AFTER_NUMBER_CHECK_IDENTIFIER_IRESULT(__VA_ARGS__)) \
/**/
...
#define BOOST_VMD_DETAIL_AFTER_NUMBER_CHECK_MORE_NUMBERS_IRESULT(...) \
	BOOST_PP_IIF \
		( \
...
#define BOOST_VMD_DETAIL_AFTER_NUMBER_CHECK_MORE_NUMBERS(...) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_AFTER_NUMBER_CHECK_MORE_NUMBERS_IRESULT(__VA_ARGS__)) \
/**/

#define BOOST_VMD_DETAIL_AFTER_NUMBER_NEXT_PEN_IRESULT(...) \
	BOOST_PP_IIF \
		( \
...
#define BOOST_VMD_DETAIL_AFTER_NUMBER_NEXT_PEN(...) \
	BOOST_VMD_DETAIL_AFTER_NUMBER_NEXT_PEN_IRESULT(__VA_ARGS__) \
/**/
...
#define BOOST_VMD_DETAIL_AFTER_NUMBER_CHECK_IDENT_IDENTIFIER_IRESULT(...) \
	BOOST_PP_IIF \
		( \
		BOOST_VMD_IS_BEGIN_TUPLE \
			( \
...
#define BOOST_VMD_DETAIL_AFTER_NUMBER_CHECK_IDENT_IDENTIFIER(...) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_AFTER_NUMBER_CHECK_IDENT_IDENTIFIER_IRESULT(__VA_ARGS__)) \
/**/

#define BOOST_VMD_DETAIL_AFTER_NUMBER_CHECK_IDENT_PARAM_IRESULT(...) \
	BOOST_PP_IIF \
		( \
		BOOST_PP_EQUAL \
			( \
...
#define BOOST_VMD_DETAIL_AFTER_NUMBER_CHECK_IDENT_PARAM(...) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_AFTER_NUMBER_CHECK_IDENT_PARAM_IRESULT(__VA_ARGS__)) \
/**/

#define BOOST_VMD_DETAIL_AFTER_NUMBER_NEXT_PEN_IDENT_IRESULT(...) \
	BOOST_PP_IIF \
		( \
		BOOST_VMD_DETAIL_PAREN_OR_EMPTY \
			( \
...
#define BOOST_VMD_DETAIL_AFTER_NUMBER_NEXT_PEN_IDENT(...) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_AFTER_NUMBER_NEXT_PEN_IDENT_IRESULT(__VA_ARGS__)) \
/**/
