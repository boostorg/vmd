...
#define BOOST_VMD_DETAIL_AFTER_NUMBER_PROCESS_RECURSE_4(...) \
...
#define BOOST_VMD_DETAIL_AFTER_NUMBER_PROCESS_RECURSE_3(...) \
	BOOST_VMD_DETAIL_AFTER_NUMBER_CAT(__VA_ARGS__) \
		( \
		BOOST_VMD_DETAIL_IS_NUMBER_CONCATENATE(BOOST_PP_VARIADIC_ELEM(0,__VA_ARGS__)), \
		BOOST_PP_DEC(BOOST_PP_VARIADIC_ELEM(1,__VA_ARGS__)) \
...
#define BOOST_VMD_DETAIL_AFTER_NUMBER_PROCESS_RECURSE_2(...) \
	BOOST_VMD_DETAIL_AFTER_NUMBER_CAT(__VA_ARGS__) \
		( \
		BOOST_VMD_DETAIL_IS_NUMBER_CONCATENATE(BOOST_PP_VARIADIC_ELEM(0,__VA_ARGS__)), \
		BOOST_PP_DEC(BOOST_PP_VARIADIC_ELEM(1,__VA_ARGS__)) \
...
#define BOOST_VMD_DETAIL_AFTER_NUMBER_PROCESS_RECURSE_ID_4(...) \
	BOOST_VMD_DETAIL_AFTER_NUMBER_CAT(__VA_ARGS__) \
		( \
		BOOST_VMD_DETAIL_IS_NUMBER_CONCATENATE(BOOST_PP_VARIADIC_ELEM(0,__VA_ARGS__)), \
		BOOST_PP_DEC(BOOST_PP_VARIADIC_ELEM(1,__VA_ARGS__)), \
...
#define BOOST_VMD_DETAIL_AFTER_NUMBER_PROCESS_RECURSE_ID_3(...) \
	BOOST_VMD_DETAIL_AFTER_NUMBER_CAT(__VA_ARGS__) \
		( \
		BOOST_VMD_DETAIL_IS_NUMBER_CONCATENATE(BOOST_PP_VARIADIC_ELEM(0,__VA_ARGS__)), \
		BOOST_PP_DEC(BOOST_PP_VARIADIC_ELEM(1,__VA_ARGS__)), \
...
#define BOOST_VMD_DETAIL_AFTER_NUMBER_PROCESS_RECURSE_ID_2(...) \
	BOOST_VMD_DETAIL_AFTER_NUMBER_CAT(__VA_ARGS__) \
		( \
		BOOST_VMD_DETAIL_IS_NUMBER_CONCATENATE(BOOST_PP_VARIADIC_ELEM(0,__VA_ARGS__)), \
		BOOST_PP_DEC(BOOST_PP_VARIADIC_ELEM(1,__VA_ARGS__)), \
		...
		BOOST_VMD_IS_EMPTY \
			...
			BOOST_PP_TUPLE_ELEM \
				...
				BOOST_PP_IIF \
					...
					BOOST_VMD_DETAIL_AFTER_NUMBER_PROCESS_RECURSE_ID_CAT(__VA_ARGS__), \
					BOOST_VMD_DETAIL_AFTER_NUMBER_PROCESS_RECURSE_CAT(__VA_ARGS__) \
					) \
				(__VA_ARGS__) \
				) \
			) \
...
#define BOOST_VMD_DETAIL_AFTER_NUMBER_NEXT_PEN_4_IRESULT(...) \
	BOOST_PP_IIF \
		( \
...
#define BOOST_VMD_DETAIL_AFTER_NUMBER_NEXT_PEN_3_IRESULT(...) \
	BOOST_PP_IIF \
		( \
		BOOST_VMD_DETAIL_PAREN_OR_EMPTY \
			( \
...
#define BOOST_VMD_DETAIL_AFTER_NUMBER_NEXT_PEN_2_IRESULT(...) \
	BOOST_PP_IIF \
		( \
		BOOST_VMD_DETAIL_PAREN_OR_EMPTY \
			( \
...
#define BOOST_VMD_DETAIL_AFTER_NUMBER_NEXT_PEN_4(...) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_AFTER_NUMBER_NEXT_PEN_4_IRESULT(__VA_ARGS__)) \
/**/

#define BOOST_VMD_DETAIL_AFTER_NUMBER_NEXT_PEN_3(...) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_AFTER_NUMBER_NEXT_PEN_3_IRESULT(__VA_ARGS__)) \
/**/

#define BOOST_VMD_DETAIL_AFTER_NUMBER_NEXT_PEN_2(...) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_AFTER_NUMBER_NEXT_PEN_2_IRESULT(__VA_ARGS__)) \
/**/
