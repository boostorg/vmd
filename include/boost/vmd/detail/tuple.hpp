...
#define BOOST_VMD_DETAIL_TUPLE_IBST(vseq) \
	BOOST_PP_IIF \
		( \
...
#define BOOST_VMD_DETAIL_TUPLE_BST(vseq) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_TUPLE_IBST(vseq)) \
/**/
...
#define BOOST_VMD_DETAIL_TUPLE_IBSEQ(vseq) \
	BOOST_PP_IIF \
		( \
...
#define BOOST_VMD_DETAIL_TUPLE_BSEQ(vseq) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_TUPLE_IBSEQ(vseq)) \
/**/
