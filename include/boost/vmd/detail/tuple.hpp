...
#define BOOST_VMD_DETAIL_TUPLE_BST_IR(vseq) \
	BOOST_PP_IIF \
		( \
...
#define BOOST_VMD_DETAIL_TUPLE_BST(vseq) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_TUPLE_BST_IR(vseq)) \
/**/
...
#define BOOST_VMD_DETAIL_TUPLE_BSEQ_IR(vseq) \
	BOOST_PP_IIF \
		( \
...
#define BOOST_VMD_DETAIL_TUPLE_BSEQ(vseq) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_TUPLE_BSEQ_IR(vseq)) \
/**/
