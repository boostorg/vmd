...
#define BOOST_VMD_DETAIL_ELEM_AFTER_IDENTIFIER_CHK_IPRE(after,tuple,mods) \
	BOOST_PP_IIF \
		( \
		BOOST_PP_BITOR \
			( \
...
#define BOOST_VMD_DETAIL_ELEM_AFTER_IDENTIFIER_CHK_PRE(after,tuple,mods) \
	BOOST_VMD_IDENTITY_RESULT(BOOST_VMD_DETAIL_ELEM_AFTER_IDENTIFIER_CHK_IPRE(after,tuple,mods)) \
/**/
