...
#define BOOST_VMD_DETAIL_INTERNAL_LIST(vseq) \
	BOOST_VMD_DETAIL_LIST(vseq,BOOST_VMD_RETURN_AFTER) \
/**/

#define BOOST_VMD_DETAIL_INTERNAL_LIST_D(d,vseq) \
	BOOST_VMD_DETAIL_LIST_D(d,vseq,BOOST_VMD_RETURN_AFTER) \
/**/
