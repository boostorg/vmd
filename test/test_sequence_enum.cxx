...
int main()
  ...
  BOOST_TEST_EQ(BOOST_PP_TUPLE_ELEM(1,BOOST_PP_VARIADIC_ELEM(3,BOOST_VMD_ENUM(ASEQUENCE2))),249);
  BOOST_TEST_EQ(BOOST_PP_VARIADIC_SIZE(BOOST_VMD_ENUM(ASEQUENCE)),6);
  BOOST_TEST_EQ(BOOST_PP_TUPLE_ELEM(0,BOOST_PP_VARIADIC_ELEM(0,BOOST_VMD_ENUM(ASEQUENCE3))),BOOST_VMD_TYPE_SEQ);
  
  /* ENUM DATA */
  
  BOOST_TEST(BOOST_VMD_IS_EMPTY(BOOST_VMD_DATA_ENUM(ASEQUENCE4)));
  BOOST_TEST(BOOST_VMD_IS_IDENTIFIER(BOOST_PP_VARIADIC_ELEM(0,BOOST_VMD_DATA_ENUM(ASEQUENCE2)),(aaa,bbb,dvd)));
  BOOST_TEST_EQ(BOOST_PP_TUPLE_ELEM(2,BOOST_PP_VARIADIC_ELEM(2,BOOST_VMD_DATA_ENUM(ASEQUENCE3))),2);
  BOOST_TEST_EQ(BOOST_PP_ARRAY_ELEM(2,BOOST_PP_VARIADIC_ELEM(4,BOOST_VMD_DATA_ENUM(ASEQUENCE))),38);
