...
int main()
  ...
  BOOST_TEST(BOOST_VMD_EQUAL(aaa,aaa));
  BOOST_TEST(BOOST_VMD_EQUAL(ddd,ddd));
  BOOST_TEST(BOOST_VMD_NOT_EQUAL(ggg,dvd));
  BOOST_TEST(BOOST_VMD_NOT_EQUAL(bbb,ccc));
  BOOST_TEST(BOOST_VMD_NOT_EQUAL(eee,eee));
