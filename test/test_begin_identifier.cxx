...
int main()
	...
	BOOST_TEST(BOOST_VMD_BEGIN_IDENTIFIER(BOOST_PP_TUPLE_ELEM(2,A_TUPLE),VMD_TEST_0_));
	BOOST_TEST(BOOST_VMD_BEGIN_IDENTIFIER(JDATA,VMD_TEST_1_));
	BOOST_TEST(BOOST_VMD_BEGIN_IDENTIFIER(BOOST_PP_SEQ_ELEM(0,A_SEQ),VMD_TEST_2_));
	BOOST_TEST(BOOST_VMD_BEGIN_IDENTIFIER(BOOST_PP_LIST_AT(A_LIST,0),VMD_TEST_3_));
	BOOST_TEST(BOOST_VMD_BEGIN_IDENTIFIER(BOOST_PP_LIST_AT(A_LIST,1),VMD_TEST_77_));
	BOOST_TEST(!BOOST_VMD_BEGIN_IDENTIFIER(JDATA,VMD_TEST_4_));
