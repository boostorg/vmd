...
int main()
	...
	BOOST_TEST_EQ(BOOST_VMD_BEGIN_NUMBER(247 33 46 77,5),247);
	BOOST_TEST_EQ(BOOST_VMD_BEGIN_NUMBER(247 33 46 77,5,(XXX)),247);
	BOOST_TEST_EQ(BOOST_VMD_BEGIN_NUMBER(247 33 46 77,4,(XXX)),247);
	BOOST_TEST_EQ(BOOST_VMD_BEGIN_NUMBER(247 33 46 77 num,4,((XXX,VMD_TEST_2_))(YYY)),247);
	BOOST_TEST(BOOST_VMD_IS_EMPTY(BOOST_VMD_BEGIN_NUMBER(247 33 46 77 num,3,((XXX,VMD_TEST_2_))(YYY))));
	BOOST_TEST(BOOST_VMD_IS_EMPTY(BOOST_VMD_BEGIN_NUMBER(247 33 46 77 num somevalue,4,((XXX,VMD_TEST_2_))(YYY))));
	BOOST_TEST_EQ(BOOST_VMD_BEGIN_NUMBER(188 33 46 77 num (here) somevalue,4,((XXX,VMD_TEST_2_))(YYY)),188);
