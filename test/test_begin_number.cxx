...
int main()
	...
	BOOST_TEST(BOOST_PP_IS_BEGIN_PARENS(BOOST_PP_TUPLE_ELEM(1,BOOST_VMD_BEGIN_NUMBER(BOOST_PP_TUPLE_ELEM(2,A_TUPLE),BOOST_VMD_RETURN_AFTER))));
	...
	BOOST_TEST(BOOST_PP_IS_BEGIN_PARENS(BOOST_PP_TUPLE_ELEM(1,BOOST_VMD_BEGIN_NUMBER(BOOST_PP_SEQ_ELEM(0,A_SEQ),BOOST_VMD_RETURN_AFTER))));
