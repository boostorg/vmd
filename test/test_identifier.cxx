...
int main()
  ...
  BOOST_TEST_EQ
	...
	BOOST_TEST(!BOOST_PP_TUPLE_ELEM(0,BOOST_VMD_IDENTIFIER(PEMPTY,WHATEVER)));
	BOOST_TEST(BOOST_VMD_IS_EMPTY(BOOST_PP_TUPLE_ELEM(1,BOOST_VMD_IDENTIFIER(PEMPTY,WHATEVER))));
	
	BOOST_TEST(!BOOST_PP_TUPLE_ELEM(0,BOOST_VMD_IDENTIFIER(PPAREN,WHATEVER)));
	BOOST_TEST(BOOST_VMD_IS_EMPTY(BOOST_PP_TUPLE_ELEM(1,BOOST_VMD_IDENTIFIER(PPAREN,WHATEVER))));
