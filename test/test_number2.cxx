...
int main()
  {
	...
	BOOST_TEST_EQ(BOOST_PP_TUPLE_ELEM(0,BOOST_VMD_NUMBER(145 ())),145);
//	BOOST_TEST_EQ(BOOST_PP_TUPLE_ELEM(0,BOOST_VMD_NUMBER(BOOST_PP_TUPLE_ELEM(2,A_TUPLE))),145);
	...
	BOOST_TEST_EQ(BOOST_PP_TUPLE_ELEM(0,BOOST_VMD_NUMBER(145 23 46)),145);
	BOOST_TEST_EQ(BOOST_PP_TUPLE_ELEM(0,BOOST_VMD_NUMBER(111 23 46)),111);
	BOOST_TEST_EQ(BOOST_PP_TUPLE_ELEM(0,BOOST_VMD_NUMBER(BOOST_PP_TUPLE_ELEM(1,BOOST_VMD_NUMBER(145 23 46)))),23);
	BOOST_TEST_EQ(BOOST_PP_TUPLE_ELEM(0,BOOST_VMD_NUMBER(BOOST_PP_TUPLE_ELEM(0,A_TUPLE2))),70);

    BOOST_TEST_EQ(BOOST_PP_TUPLE_ELEM(0,BOOST_VMD_NUMBER(BOOST_PP_TUPLE_ELEM(0,A_TUPLE3))),70);
    BOOST_TEST_EQ(BOOST_PP_TUPLE_ELEM(0,BOOST_VMD_NUMBER(135 249 somevalue zzz)),135);
    BOOST_TEST_EQ(BOOST_PP_TUPLE_ELEM(0,BOOST_VMD_NUMBER(135 249 zzz)),135);
    
	BOOST_TEST_EQ(BOOST_PP_TUPLE_ELEM(0,BOOST_VMD_NUMBER(145 23 zzz (here))),145);
