...
int main()
  ...
  BOOST_TEST(BOOST_VMD_IS_EMPTY(BOOST_VMD_AFTER_ARRAY_ELEM(0,ANIDENTIFIER)));
  BOOST_TEST_EQ(BOOST_PP_SEQ_ELEM(0,BOOST_VMD_AFTER_ARRAY_ELEM(4,ASEQUENCE)),25);
  BOOST_TEST(!BOOST_VMD_IS_EMPTY(BOOST_VMD_AFTER_ARRAY_ELEM(1,ASEQUENCE2)));
  BOOST_TEST(BOOST_VMD_IS_EMPTY(BOOST_VMD_AFTER_ARRAY_ELEM(1,ASEQUENCE3)));
  BOOST_TEST(BOOST_VMD_IS_EMPTY(BOOST_VMD_AFTER_ARRAY_ELEM(0,ASEQUENCE4)));
  
#if !BOOST_VMD_MSVC_V8
  BOOST_TEST_EQ(BOOST_PP_TUPLE_ELEM(1,BOOST_VMD_AFTER_ARRAY_ELEM(2,ASEQUENCE5)),1);
#endif
