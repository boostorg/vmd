...
int main()
  ...
  BOOST_TEST(!BOOST_VMD_IS_EMPTY(BOOST_VMD_AFTER_TUPLE_ELEM(2,ASEQUENCE)));
  BOOST_TEST(BOOST_VMD_IS_EMPTY(BOOST_VMD_AFTER_TUPLE_ELEM(4,ASEQUENCE2)));
  BOOST_TEST_EQ(BOOST_PP_LIST_AT(BOOST_VMD_AFTER_TUPLE_ELEM(2,ASEQUENCE3),3),3);
  BOOST_TEST(BOOST_VMD_IS_EMPTY(BOOST_VMD_AFTER_TUPLE_ELEM(0,ASEQUENCE4)));
  BOOST_TEST(!BOOST_VMD_IS_EMPTY(BOOST_VMD_AFTER_TUPLE_ELEM(2,ASEQUENCE5)));
