...
int main()
  ...
  BOOST_TEST(!BOOST_VMD_IS_EMPTY(BOOST_VMD_AFTER_LIST_ELEM(1,ASEQUENCE)));
  BOOST_TEST(!BOOST_VMD_IS_EMPTY(BOOST_VMD_AFTER_LIST_ELEM(3,ASEQUENCE2)));
  BOOST_TEST(BOOST_VMD_IS_EMPTY(BOOST_VMD_AFTER_LIST_ELEM(3,ASEQUENCE3)));
  BOOST_TEST(BOOST_VMD_IS_EMPTY(BOOST_VMD_AFTER_LIST_ELEM(0,ASEQUENCE4)));
  BOOST_TEST(!BOOST_VMD_IS_EMPTY(BOOST_VMD_AFTER_LIST_ELEM(0,ASEQUENCE5)));
