...
int main()
  ...
  BOOST_TEST_EQ(BOOST_PP_TUPLE_ELEM(0,BOOST_PP_SEQ_ELEM(1,BOOST_VMD_TO_SEQ(ASEQUENCE3))),BOOST_VMD_TYPE_NUMBER);
  BOOST_TEST(BOOST_VMD_IS_TUPLE(BOOST_PP_TUPLE_ELEM(1,BOOST_PP_SEQ_ELEM(4,BOOST_VMD_TO_SEQ(ASEQUENCE2)))));
  BOOST_TEST_EQ(BOOST_PP_LIST_AT(BOOST_PP_TUPLE_ELEM(1,BOOST_PP_SEQ_ELEM(1,BOOST_VMD_TO_SEQ(ASEQUENCE))),3),3);
  BOOST_TEST(BOOST_VMD_IS_EMPTY(BOOST_VMD_TO_SEQ(ASEQUENCE4)));
  
  /* TO_SEQ_DATA */
  
  BOOST_TEST_EQ(BOOST_PP_SEQ_ELEM(1,BOOST_PP_SEQ_ELEM(1,BOOST_VMD_DATA_TO_SEQ(ASEQUENCE2))),26);
  BOOST_TEST(BOOST_VMD_IS_EMPTY(BOOST_VMD_DATA_TO_SEQ(ASEQUENCE4)));
  BOOST_TEST_EQ(BOOST_PP_TUPLE_ELEM(1,BOOST_PP_SEQ_ELEM(2,BOOST_VMD_DATA_TO_SEQ(ASEQUENCE))),1);
  BOOST_TEST_EQ(BOOST_PP_SEQ_ELEM(1,BOOST_VMD_DATA_TO_SEQ(ASEQUENCE3)),17);
