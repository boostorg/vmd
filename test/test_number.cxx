...
int main()
  {
	...
	BOOST_TEST(BOOST_VMD_IS_BEGIN_TUPLE(BOOST_PP_TUPLE_ELEM(1,BOOST_VMD_NUMBER(BOOST_PP_TUPLE_ELEM(2,A_TUPLE)))));
	...
	BOOST_TEST(BOOST_VMD_IS_BEGIN_TUPLE(BOOST_PP_TUPLE_ELEM(1,BOOST_VMD_NUMBER(BOOST_PP_SEQ_ELEM(0,A_SEQ)))));
    ...
    BOOST_TEST_EQ(BOOST_PP_TUPLE_ELEM(0,BOOST_VMD_NUMBER(BOOST_PP_TUPLE_ELEM(0,A_TUPLE3),5,(VMD_TEST_77_)(VMD_TEST_2_))),70);
    BOOST_TEST_EQ(BOOST_PP_TUPLE_ELEM(0,BOOST_VMD_NUMBER(135 249 somevalue zzz,2,(VMD_TEST_1_)(VMD_TEST_0_))),135);
	BOOST_TEST(BOOST_VMD_IS_EMPTY(BOOST_PP_TUPLE_ELEM(0,BOOST_VMD_NUMBER(145 23 zzz (here),2,((VMD_TEST_1_,VMD_TEST_2_,VMD_TEST_3_))))));
    BOOST_TEST_EQ(BOOST_PP_TUPLE_ELEM(0,BOOST_VMD_NUMBER(135 249 zzz,2,(VMD_TEST_0_))),135);
	BOOST_TEST(BOOST_VMD_IS_EMPTY(BOOST_PP_TUPLE_ELEM(0,BOOST_VMD_NUMBER(145 23 zzz (here),3,((VMD_TEST_0_,VMD_TEST_2_,VMD_TEST_3_))))));
	BOOST_TEST(BOOST_VMD_IS_EMPTY(BOOST_PP_TUPLE_ELEM(0,BOOST_VMD_NUMBER(145 23 zzz (here),tree))));
	BOOST_TEST(BOOST_VMD_IS_EMPTY(BOOST_PP_TUPLE_ELEM(0,BOOST_VMD_NUMBER(145 23 zzz (here),2,5))));
	
	BOOST_TEST(BOOST_VMD_IS_EMPTY(BOOST_PP_TUPLE_ELEM(0,BOOST_VMD_NUMBER(145 23 zzz (here),2,((HERE))))));
	BOOST_TEST(BOOST_VMD_IS_EMPTY(BOOST_PP_TUPLE_ELEM(0,BOOST_VMD_NUMBER(145 zzz (here),((HERE))))));
