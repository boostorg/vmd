...
int main()
  {
	...
	BOOST_TEST_EQ(BOOST_PP_TUPLE_ELEM(0,BOOST_VMD_NUMBER(145 23 46,2)),145);
	BOOST_TEST_EQ(BOOST_PP_TUPLE_ELEM(0,BOOST_VMD_NUMBER(111 23 46,2)),111);
	BOOST_TEST_EQ(BOOST_PP_TUPLE_ELEM(0,BOOST_VMD_NUMBER(BOOST_PP_TUPLE_ELEM(1,BOOST_VMD_NUMBER(145 23 46,2)),1)),23);
