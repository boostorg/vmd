...
int main()
  ...
  BOOST_TEST(BOOST_VMD_IS_NUMBER(BOOST_VMD_NUMBER_ELEM(0,BOOST_PP_TUPLE_ELEM(1,BOOST_VMD_ELEM(0,ASEQUENCE3,BOOST_VMD_RETURN_AFTER)))));
  ...
  BOOST_TEST_EQ(BOOST_PP_SEQ_ELEM(0,BOOST_VMD_ELEM(0,ASEQUENCE3)),25);
