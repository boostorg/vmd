...
int main()
  ...
  BOOST_TEST(BOOST_VMD_SEQ_EQUAL(ASEQ,ASEQ3));
  BOOST_TEST(BOOST_VMD_SEQ_EQUAL(ASEQ4,ASEQ6));
  BOOST_TEST(BOOST_VMD_SEQ_EQUAL(ASEQ7,ASEQ9));
  BOOST_TEST(BOOST_VMD_SEQ_NOT_EQUAL(ASEQ,ASEQ2));
  BOOST_TEST(BOOST_VMD_SEQ_NOT_EQUAL(ASEQ4,ASEQ5));
  BOOST_TEST(BOOST_VMD_SEQ_NOT_EQUAL(ASEQ7,ASEQ8));
