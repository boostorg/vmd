...
int main()
  ...
  BOOST_TEST(BOOST_VMD_TUPLE_EQUAL(ATUPLE,ATUPLE2));
  BOOST_TEST(BOOST_VMD_TUPLE_EQUAL(ATUPLE4,ATUPLE5));
  BOOST_TEST(BOOST_VMD_TUPLE_NOT_EQUAL(ATUPLE2,ATUPLE3));
  BOOST_TEST(BOOST_VMD_TUPLE_NOT_EQUAL(ATUPLE4,ATUPLE6));
