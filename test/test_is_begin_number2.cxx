...
int main()
	...
	BOOST_TEST(BOOST_VMD_IS_BEGIN_NUMBER(44 22));
	BOOST_TEST(BOOST_VMD_IS_BEGIN_NUMBER(189 22 num somevalue));
	BOOST_TEST(BOOST_VMD_IS_BEGIN_NUMBER(232 num somevalue));
	BOOST_TEST(!BOOST_VMD_IS_BEGIN_NUMBER(sleep num somevalue));
