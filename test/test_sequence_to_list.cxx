...
int main()
  ...
  BOOST_TEST_EQ(BOOST_PP_SEQ_ELEM(0,BOOST_PP_TUPLE_ELEM(1,BOOST_PP_LIST_AT(BOOST_VMD_TO_LIST(ASEQUENCE),5))),25);
  BOOST_TEST_EQ(BOOST_PP_TUPLE_ELEM(1,BOOST_PP_LIST_AT(BOOST_VMD_TO_LIST(ASEQUENCE2),3)),249);
  BOOST_TEST_EQ(BOOST_PP_TUPLE_ELEM(0,BOOST_PP_LIST_AT(BOOST_VMD_TO_LIST(ASEQUENCE3),2)),BOOST_VMD_TYPE_TUPLE);
  BOOST_TEST_EQ(BOOST_PP_LIST_SIZE(BOOST_VMD_TO_LIST(ASEQUENCE4)),0);
  
  /* TO_LIST_DATA */
  
  BOOST_TEST_EQ(BOOST_PP_TUPLE_ELEM(3,BOOST_PP_LIST_AT(BOOST_VMD_DATA_TO_LIST(ASEQUENCE),2)),3);
  BOOST_TEST(BOOST_VMD_IS_IDENTIFIER(BOOST_PP_LIST_AT(BOOST_VMD_DATA_TO_LIST(ASEQUENCE2),0),(aaa,bbb,dvd)));
  BOOST_TEST_EQ(BOOST_PP_TUPLE_ELEM(0,BOOST_PP_LIST_AT(BOOST_VMD_DATA_TO_LIST(ASEQUENCE3),2)),0);
  BOOST_TEST_EQ(BOOST_PP_LIST_SIZE(BOOST_VMD_DATA_TO_LIST(ASEQUENCE4)),0);
